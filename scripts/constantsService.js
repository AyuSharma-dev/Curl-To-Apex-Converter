...
/*
*   The Request Contains Form Body, Apex does not support this natively.
*   Please create the below class to create Http Request Body.
*   The credit for this class goes to 'https://github.com/MetaMind/apex-utils/blob/master/HttpFormBuilder.apex'
*/
...
function getResponseHandlingConstants(){
    return `
